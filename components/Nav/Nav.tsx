  ...
  return (
    <div className="cheesecake-font font-bold text-yellow-300">
      ...
      <div className="flex items-center relative">
        ...
        <h1 className="text-3xl translate-x-[-25px]">heesecake</h1>
        <h1 className="text-8xl translate-x-[-25px]">F</h1>
        <h1 className="text-3xl translate-x-[-25px]">actory</h1>
      </div>
    </div>
  )
}
...
const Nav = () => {
  ...
  return (
    <motion.nav initial={initialDrop} animate={animateDrop} className="py-2 px-10 flex justify-between items-center p-4">
