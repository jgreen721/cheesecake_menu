...
<div className="absolute bg-white h-full w-full opacity-50 top-0 left-0 flex items-center justify-center">
  <div className="absolute border-champagne border-4 w-[95%] h-[90%]"></div>
      ...
      <div className="px-4 relative">
        <h1 className="text-3xl md:text-6xl my-3">Join Our Rewards</h1>
        <h5 className="text-md md:text-xl my-10">Our exciting new program is now available nationwide! With complimentary slices of cheesecake, access to reservations, suprise  delight rewards, and no points to track, why wouldn't you sign-up?</h5>
        <div className="flex items-center justify-center flex-col md:flex-row gap-2 py-4">
